...
fun validationIdCorrect(command: MkpCommand, processor: MkpOpProcessor) = runTest {
    val ctx = MkpContext(
        command = command,
        state = MkpState.NONE,
...
fun validationIdTrim(command: MkpCommand, processor: MkpOpProcessor) = runTest {
    val ctx = MkpContext(
        command = command,
        state = MkpState.NONE,
        workMode = MkpWorkMode.TEST,
...
fun validationIdEmpty(command: MkpCommand, processor: MkpOpProcessor) = runTest {
    val ctx = MkpContext(
        command = command,
        state = MkpState.NONE,
        workMode = MkpWorkMode.TEST,
...
fun validationIdFormat(command: MkpCommand, processor: MkpOpProcessor) = runTest {
    val ctx = MkpContext(
        command = command,
        state = MkpState.NONE,
        workMode = MkpWorkMode.TEST,
